...
##########################
## Mattermost Keycloak Patch
This fork implements SSO via Keycloak. It replicates the same flow and configuration and the SSO GitLab.

Forked from Mattermost 3.6.2

This has not been thoroughly tested and is provided as is.
##########################
